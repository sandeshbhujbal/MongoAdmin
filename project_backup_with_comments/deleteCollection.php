...
?>
	...
	<script>
		alert("Error While deleting Database."); 
		window.location.href="index1.php";				
	</script>
...
//	die('Failed to connect to MongoDB '.$e->getMessage());
	...
	$temp='&authenticate='.$authentication;
...
?>
	...
	<script>
		...
		window.location.href="index1.php?host=<?php echo $host; ?>&port=<?php echo $port; ?><?php echo $temp; ?>";
	</script>
...
?>
	<script>
		alert("Error while deleting Collection. <?php echo $response['errmsg'];?>"); 
		window.location.href="index1.php?host=<?php echo $host; ?>&port=<?php echo $port; ?><?php echo $temp; ?>";
	</script>
<?php
